...
typedef enum {
    ...
    _ADC0_DP0  = (0 << ADC_INSTANCE_SHIFT) | 0,
    _ADC0_DM0  = (0 << ADC_INSTANCE_SHIFT) | 19,
    _ADC0_DP1  = (0 << ADC_INSTANCE_SHIFT) | 1,
    _ADC0_DM1  = (0 << ADC_INSTANCE_SHIFT) | 20,
    _ADC0_DP3  = (0 << ADC_INSTANCE_SHIFT) | 3,
    _ADC0_TEMP = (0 << ADC_INSTANCE_SHIFT) | 26,
    _ADC0_BANDGAP = (0 << ADC_INSTANCE_SHIFT) | 27,
    _ADC0_VREFH = (0 << ADC_INSTANCE_SHIFT) | 29,
    _ADC0_VREFL = (0 << ADC_INSTANCE_SHIFT) | 30,
    _ADC1_DM3 = (0 << ADC_INSTANCE_SHIFT) | 19,
    _ADC0_DM3  = (1 << ADC_INSTANCE_SHIFT) | 19,
    ...
    _ADC1_DP0  = (1 << ADC_INSTANCE_SHIFT) | 0,
    _ADC1_DM0  = (1 << ADC_INSTANCE_SHIFT) | 19,
    _ADC1_DP1  = (1 << ADC_INSTANCE_SHIFT) | 1,
    _ADC1_DM1  = (1 << ADC_INSTANCE_SHIFT) | 20,
    _ADC1_DP3  = (1 << ADC_INSTANCE_SHIFT) | 3,
} ADCName;
